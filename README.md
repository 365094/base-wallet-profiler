# base-wallet-profiler

Build a public-safe wallet profile template.
...
```bash
git clone https://github.com/YOUR_GITHUB_USERNAME/base-wallet-profiler.git
cd base-wallet-profiler
python3 -m venv .venv
